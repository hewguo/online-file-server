...
LOG_PATH=$DEPLOY_DIR/log/online-file
...
EXEC_CMDLINE="java -classpath ${CLASSPATH} ${USER_VMARGS} ${GC_OPTS} ${JAVA_JMX_OPTS} ${JAVA_DEBUG} ${JAVA_OPTS} com.suolashare.file.FileApplication"
